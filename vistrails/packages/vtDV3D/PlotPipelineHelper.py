...
#        return action
    ...
    @staticmethod
    def update_plot_pipeline_action1(controller, version, var_modules, plot_objs,
                                    row, col):
        ...
        ops = []
 #       plot_modules = PlotPipelineHelper.find_modules_by_type(pipeline, [ MapCell3D, CloudCell3D ])
        cell_module = PlotPipelineHelper.find_modules_by_type(pipeline, [ MapCell3D, CloudCell3D ])
        reader_modules = PlotPipelineHelper.find_modules_by_type( pipeline, [ CDMS_VolumeReader, CDMS_HoffmullerReader, CDMS_SliceReader, CDMS_VectorReader ] )
