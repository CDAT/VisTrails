...
class PVIsoSurface(SpreadsheetCell):
    def __init__(self):
...
def registerSelf():
    ...
    registry.add_module(PVIsoSurface, configureWidgetType=PVClimateCellConfigurationWidget)
    registry.add_input_port(PVIsoSurface, "Location", CellLocation)
    registry.add_input_port(PVIsoSurface, "variable", pvvariable.PVVariableConstant)    
    registry.add_input_port(PVIsoSurface, "isoSurfaces", basic_modules.String)
    registry.add_output_port(PVIsoSurface, "self", PVIsoSurface)
