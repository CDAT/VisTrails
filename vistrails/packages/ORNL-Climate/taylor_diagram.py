...
class TaylorDiagram(object):
    ...
    def __init__(self, refstd, refcorrcoef=1.0, fig=None, rect=111, label='_', srange=(0,1.5)):
        ...
        * srange: stddev axis extension, in units of *refstd*
        ...
        l, = self.ax.plot(NP.arccos(refcorrcoef), self.refstd, 'k*',
...
def test3():
    ...
    dia = TaylorDiagram(samples[0][0], samples[0][1], fig=fig, label=labels[0])
    dia.samplePoints[0].set_color('r')  # Mark reference point as a red star

    # Add models to Taylor diagram
    for i,( (stddev,corrcoef),name) in enumerate(zip(samples[1:], labels[1:])):
