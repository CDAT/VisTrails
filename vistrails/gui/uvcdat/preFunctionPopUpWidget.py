...
#                                                                             #
# Description:  UV-CDAT GUI prefunction.                                      #
#                                                                             #
# Version:      6.0                                                           #
#                                                                             #
###############################################################################
...
class preFuncPopUp(QtGui.QDialog):
    def __init__(self,parent=None,defs={}):
        ...
        if defs.get("axes",True):
            axFrame = uvcdatCommons.QFramedWidget("Axes Options:")
        ...
        ## Ok now the "choices"
        self.choices=[]
        choices = uvcdatCommons.QFramedWidget("Options:")
        hasChoices = False
        ...
        hasEntries = False
        entries = uvcdatCommons.QFramedWidget("Entries:")
        ## Files entries first
...
class QFileOpener(QtGui.QWidget):
    def __init__(self,label):
        ...
        i = QtGui.QIcon(os.path.join(customizeUVCDAT.ICONPATH,"Open_folder.gif"))
        b = QtGui.QToolButton()
        b.setIcon(i)
