...
class QTemplatesWidget(QtGui.QWidget):
    def __init__(self,parent=None):
        ...
        self.templateList = uvcdatCommons.QDragListWidget(type="templates")
        self.templateList.setToolTip("Drag and Drop into 'Template' Box below")
##         self.templateList.setAlternatingRowColors(True)
        ...
        for i in range(len(tpl)):
            ...
            if t == customizeUVCDAT.defaultTemplateName:
                default = i
