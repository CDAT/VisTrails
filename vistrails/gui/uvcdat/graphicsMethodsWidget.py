...
class QGraphicsMethodsWidget(QtGui.QWidget):
    def __init__(self,ptype,parent=None):
        ...
        self.gmList = uvcdatCommons.QDragListWidget(type="graphicmethods")
        self.gmList.setToolTip("Drag and Drop into 'GM' Box below")
##         self.gmList.setAlternatingRowColors(True)
        ...
        for i in range(len(gms)):
            ...
            if g == customizeUVCDAT.defaultGraphicsMethodName:
                default = i
